...
ini_set('include_path', ABS_PATH_TO_HOME.'include');
...
$signup_errors=array(
		'all_correct'=>array('status'=>true, 'err_msg'=>'We encountered the following errors:'),
		'password_match'=>array('status'=>true,'err_msg'=>'Passwords do not match'),
		'allowed_age'=>array('status'=>true,'err_msg'=>'You need to be 14 years or older to signup.'),
		'valid_email'=>array('status'=>true,'err_msg'=>'The email address provided was not valid.'),
		'agree_to_terms'=>array('status'=>true,'err_msg'=>'You need to agree to our Terms of Service.'),
		'unique_email'=>array('status'=>true,'err_msg'=>'Email address entered is already registered. Please use another email address.'),
		'unique_username'=>array('status'=>true,'err_msg'=>'Username provided is not available. Please try some other username.'),
		'form_complete'=>array('status'=>true,'err_msg'=>'The form is incomplete. Please fill the form again.')
	);
